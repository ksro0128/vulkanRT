...
std::unique_ptr<RayTracingPipeline> RayTracingPipeline::createRayTracingPipeline(VulkanContext* context, std::vector<DescriptorSetLayout*> descriptorSetLayouts) {
	std::unique_ptr<RayTracingPipeline> pipeline = std::unique_ptr<RayTracingPipeline>(new RayTracingPipeline());
	pipeline->init(context, descriptorSetLayouts);
	return pipeline;
}	

void RayTracingPipeline::init(VulkanContext* context, std::vector<DescriptorSetLayout*> descriptorSetLayouts) {
